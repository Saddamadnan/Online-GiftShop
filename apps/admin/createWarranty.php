...
<?php
if(isset($_POST['btn'])){
	$input->post('warranty')->isEmpty()->digit();
	$name = $input->values['warranty'];
	$sql = "insert into warranty(name) values('".$name."')";
	$d = new DBContext;
...
<form action="" method="post">
	...
	<input type="text" name="warranty" placeholder="Enter here.." class="form-control"><br><br>
